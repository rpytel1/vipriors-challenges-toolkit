...
# Write a dictionary as json file
def writeDict2Txt(dictName, fileName):
    with open(fileName, 'w') as f:
        f.write('IoU Class: '+str(dictName['averageScoreClasses'])+'\n')
        f.write('iIoU Class: '+str(dictName['averageScoreInstClasses'])+'\n')
        f.write('IoU Category: '+str(dictName['averageScoreCategories'])+'\n')
        f.write('iIoU Category: '+str(dictName['averageScoreInstCategories'])+'\n')
        f.write('Accuracy: '+str(dictName['accuracy']))
